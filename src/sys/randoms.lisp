...
(defun get-uniform-xy-variants (&optional (number-of-samples 1))
  ;; Return a list with NUMBER-OF-SAMPLES [default 1] lists of single float pairs, each of which is a uniform variant over 0.0 and 1.0.
...
(defun poisson-events (lambda start stop &optional (min-interval-value 0.0))
  "Returns a list of times generated by a Poisson process with rate constant LAMBDA [1/ms], starting at START and ending with STOP
[ms]. Poisson intervals are taken at a minimum value of MIN-INTERVAL-VALUE [ms]."
  (declare (optimize (safety 0) (speed 3) (space 0) (compilation-speed 0)))
...
TIME-OFFSET [ms].  Poisson intervals are taken at a minimum value of MIN-INTERVAL-VALUE [ms]."
;  (declare (optimize (safety 0) (speed 3) (space 0) (compilation-speed 0)))
