...
;;; Bugs and Fixes
;;;   binomial cumulative has a bug because betai has a bug
...
(binomial-cumulative 0 0 .02)  -> produces a complex number
(binomial-cumulative 1 1 .02)  -> produces a complex number

(betai 0 1 .98) -> produces a complex number
(betai 0 2 .98) -> produces a complex number

(binomial-cumulative-naive 0 0 .02)
(binomial-cumulative-naive 1 1 .02)
