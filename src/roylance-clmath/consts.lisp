...
0]] (defcon velocity-of-light	c	2.9979250e8 meters per second)
...
Error in function NIL:  Execution of a form compiled with errors:
 (DECLARE (SPECIAL VELOCITY-OF-LIGHT) (FLOAT VELOCITY-OF-LIGHT))
...
(defmacro defcon (name symbol number . dimensions)
  `(progn (defconstant ,name ,number)
	  (proclaim (list `float ',name))))
