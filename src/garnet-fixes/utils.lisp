...
;; This is an industrial-strength version of opal:directory-p.  The
;; difference is that extra work is done to ensure that single and
;; double quotes are passed to the shell correctly.  Since it does
;; more work, only use this version if you find you really need it.
;; This code was contributed by Bruno Haible.
