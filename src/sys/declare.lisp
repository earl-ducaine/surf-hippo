...
(defvar *main-menu-image*
  (create-instance nil opal:bitmap
    (:filling-style
     (create-instance nil opal:filling-style (:fill-style :stippled)))
    (:image (opal:read-image (namestring (concatenate-strings
					  (namestring *SURF-HOME*)
					  "lib/pix/cool-hippo.small.bmp"))))))
