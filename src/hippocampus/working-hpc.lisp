...
(defun working-hpc (&key (name "Working-HPC") (origin '(0 0 0)) (active t))
  (ball-and-sticks :name name :cell-type 'BG-97-HPC :origin origin :soma-diameter 35
		   :include-apical t :apical-total-segs 5 :apical-dendrite-diameter 12 :apical-dendrite-length 1200
		   :include-basal nil)
