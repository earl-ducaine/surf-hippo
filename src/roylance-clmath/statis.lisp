...
(eval-when (compile load eval)
  ...
  (module-require "BETA-FUNCTION"))
|#

#+ignore
(DECLARE (FLOAT (UNIFORM-DENSITY          FLOAT)
		(UNIFORM-CUMULATIVE       FLOAT)
		(NORMAL-DENSITY           FLOAT)
		(NORMAL-CUMULATIVE        FLOAT)
		(NORMAL-TAIL              FLOAT)
		(EXPONENTIAL-DENSITY      FLOAT FLOAT)
		(EXPONENTIAL-CUMUMULATIVE FLOAT FLOAT)
		(CAUCHY-DENSITY           FLOAT)
		(CAUCHY-CUMULATIVE        FLOAT)
		(CHI-SQUARE-DENSITY       FLOAT FIXNUM)
		(CHI-SQUARE-CUMULATIVE    FLOAT FIXNUM)
		(T-DENSITY                FLOAT FIXNUM)
		(T-CUMULATIVE             FLOAT FIXNUM)
		(T-TWO-SIDED              FLOAT FIXNUM)
		(F-DENSITY                FLOAT FIXNUM FIXNUM)
		(F-CUMULATIVE             FLOAT FIXNUM FIXNUM)
		(GAMMA-DENSITY            FLOAT FLOAT)
		(GAMMA-CUMULATIVE         FLOAT FLOAT)
		(BETA-DENSITY             FLOAT FLOAT FLOAT)
		(BETA-CUMULATIVE          FLOAT FLOAT FLOAT)
		(UNIFORM-RANDOM-NUMBER)
		(NORMAL-RANDOM-NUMBER)
		(EXPONENTIAL-RANDOM-NUMBER FLOAT)
		(CAUCHY-RANDOM-NUMBER)
		(CHI-SQUARE-RANDOM-NUMBER FIXNUM)
		(T-RANDOM-NUMBER          FIXNUM)
		(F-RANDOM-NUMBER          FIXNUM FIXNUM)
		(GAMMA-RANDOM-NUMBER      NOTYPE)
		(BETA-RANDOM-NUMBER       NOTYPE NOTYPE))
	 (FIXNUM (POISSON-RANDOM-NUMBER    FLOAT)))
...
(defun EXPONENTIAL-RANDOM-NUMBER (lambda)
  (do ((u 0.0)
       (v 0.0))
      ((progn
